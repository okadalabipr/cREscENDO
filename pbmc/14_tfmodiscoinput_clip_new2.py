#export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:/software/2020/software/miniconda3/23.9.0-0/lib
...
cellclus=pd.read_csv("/users/ken.murakami/workspace/cellcluster_all.txt",header=None)
