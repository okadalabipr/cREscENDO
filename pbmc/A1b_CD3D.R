...
print(g)
ggsave(paste0(working_dir_path,"/pbmc_cluster.pdf"),width = 8, height = 6)


CD3D<-read.csv(paste0(working_dir_path,"/CD3Dactivity.csv"),sep="\t",header=F)
...
ggsave(paste0(working_dir_path,"/CD3D_rna.pdf"),width = 8, height = 6)
...
ggsave(paste0(working_dir_path,"/CD3D_promoter.pdf"),width = 8, height = 6)
...
ggsave(paste0(working_dir_path,"/CD3D_chr11_118334494_118335388.pdf"),width = 8, height = 6)
...
ggsave(paste0(working_dir_path,"/CD3D_chr11_118241249_118242001.pdf"),width = 8, height = 6)
