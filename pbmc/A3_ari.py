...
fnamelist1=[samplename+"/try1",samplename+"/try2",samplename+"/try3",samplename+"/try4",samplename+"/try5"]
fnamelist2=[samplename+"/scenicplus_for_paper/try1",samplename+"/scenicplus_for_paper/try2",samplename+"/scenicplus_for_paper/try3",samplename+"/scenicplus_for_paper/try4",samplename+"/scenicplus_for_paper/try5"]
...
plt.savefig(samplename+"/barplot_ARI.pdf",format="pdf")
