...
eqtl_tmp=pd.read_csv('CAVIAR_Results_v8_GTEx_LD_ALL_NOCUTOFF.txt',sep="\t")
eqtl_tmp_sep=eqtl_tmp[eqtl_tmp["TISSUE"]=='Whole_Blood']
eqtl_tmp_sep.to_csv("CAVIAR_Results_v8_GTEx_LD_ALL_NOCUTOFF_Whole_Blood.txt",sep="\t")
...
ensemblelist=pd.read_csv('ensemblelist.csv')
...
eqtl_tmp_sep=pd.read_csv('CAVIAR_Results_v8_GTEx_LD_ALL_NOCUTOFF_Whole_Blood.txt',sep="\t",index_col=0)
...
np.save("eqtl_mtx_all_cav.npy",eqtl_mtx_all_cav)
...
np.save("eqtl_mtx_sig05.npy",eqtl_mtx_sig)