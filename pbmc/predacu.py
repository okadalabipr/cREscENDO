...
obser=pd.read_csv(samplename+"/RNAmatrix_raw.txt",header=None,sep=" ")
...
plt.savefig(samplename+"/predacu.pdf",format="pdf")
...
plt.subplots_adjust(left=0.20)
plt.subplots_adjust(bottom=0.40)
plt.savefig(samplename+"/predacu_fantom5.pdf",format="pdf")
...
plt.subplots_adjust(left=0.20)
plt.subplots_adjust(bottom=0.40)
plt.savefig(samplename+"/predacu_pchic.pdf",format="pdf")
